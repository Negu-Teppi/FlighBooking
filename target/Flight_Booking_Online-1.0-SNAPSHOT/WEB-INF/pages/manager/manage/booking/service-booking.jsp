                ...
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        ...
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            ...
                            <li><a class="parent-item" href="">Booking Detail</a>&nbsp;<i class="fa fa-angle-right"></i>
                            </li>
                                ...
                                <div class="table-scrollable">
                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
                                        ...
                                        <c:forEach items="${serviceBookings}" var="sb">
                                            <tbody>
                                            <tr class="odd gradeX">
                                                <td class="center">${sb.service.name}</td>
                                                <td class="center" style="width: 150px">${sb.service.description}</td>
                                                <td class="center">${sb.service.price}</td>
                                                <td class="center">
                                                    <a href="<c:url
                                                        value="/manager/booking/addService/${sb.id}"/> "
