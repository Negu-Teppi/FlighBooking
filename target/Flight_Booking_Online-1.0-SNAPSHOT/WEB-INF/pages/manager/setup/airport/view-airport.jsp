                            ...
                            <div class="card-body ">
                                ...
                                <div class="table-scrollable">
                                    <table class="table table-hover table-checkable order-column full-width" id="example4">
                                        ...
                                        <c:forEach items="${airports.content}" var="airport">
                                            <tbody>
                                            <tr class="odd gradeX">
                                                <td style="width:30%">${airport.airportName}</td>
                                ...
                                <div class="row p-b-20">
                                    <nav aria-label="Page navigation example" style="text-align: center">
                                        <ul class="pagination">
                                            <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/manager/view/airport?page=0">First</a></li>
                                            <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/manager/view/airport?page=${airports.number - 1}">Previous</a></li>
                                            <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/manager/view/airport?page=${airports.number + 1}">Next</a></li>
                                            <li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/manager/view/airport?page=${airports.totalPages - 1}">Last</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
